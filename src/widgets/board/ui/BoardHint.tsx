...
const HINTS: Record<Tool, React.ReactNode> = {
  cursor: <>Потяни — выделить · Клик по блоку — выбрать · Двойной клик — редактировать текст · <span className="board-hint-dot">●</span> — стрелка · Клик по стрелке — выделить, ещё раз — изгиб</>,
  ...
  frame:  <>Кликни или потяни — создать фрейм · Блоки внутри двигаются вместе с ним · Esc — отмена</>,
};
